...
The public GitHub Pages Demo runs in template mode by default. Optional DeepSeek access is routed through the local `demo/V1.0/llm-proxy.mjs`; no API key belongs in frontend code or repository history.
