...
> 文档状态：v0.2.2（已对齐 v0.6 Demo + v0.7 Mock 查询层）
> 版本日期：2026-08-26
> 文档性质：公开产品需求与验收文档，基于当前 v6 Demo、对象模型、规则表、输入输出契约、AI 层方案和场景扩展方案整理。
...
| v0.8 | 受控只读媒体工具：趋势、实验组和配置变更查询 | ⏳ 后续 |
| v1.0 | 真实 LLM、离线回归集、线上质量监控和人工确认闭环 | ⏳ 目标 |
